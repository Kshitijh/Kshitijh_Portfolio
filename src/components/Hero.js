    ...
    <section className="py-5" id="home">
      <div className="container ">
        <Row className="g-4 align-items-center">
          {/* Left Content */}
          <Col lg={8}>
            <Card className="p-4 shadow-sm " data-aos="flip-up">
              <h1>
            ...
            <Row className="mt-3 g-3">
              <Col xs={12} md={4}>
                <Card className="p-3 shadow-sm text-center" data-aos="flip-up" data-aos-delay="100">
                  <div>Experience</div>
                  <div className="fw-bold mt-1">Internships + Freelance</div>
                </Card>
              </Col>
              <Col xs={12} md={4}>
                <Card className="p-3 shadow-sm text-center" data-aos="flip-up" data-aos-delay="200">
                  <div>Top Skill</div>
                  <div className="fw-bold mt-1">React • Python</div>
                </Card>
              </Col>
              <Col xs={12} md={4}>
                <Card className="p-3 shadow-sm text-center" data-aos="flip-up" data-aos-delay="300">
                  <div>Degree</div>
          ...
          {/* Profile Card */}
          <Col lg={4}>
            <Card className="p-4 shadow-sm text-center align-items-center hero-right" data-aos="flip-up">
              <img
                src={profile}
                alt="Profile"
